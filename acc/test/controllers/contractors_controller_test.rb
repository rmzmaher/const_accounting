...
class ContractorsControllerTest < ActionController::TestCase
  ...
  test "should create contractor" do
    assert_difference('Contractor.count') do
      post :create, contractor: { name: @contractor.name, note: @contractor.note, phone: @contractor.phone, type: @contractor.type }
    end
  ...
  test "should update contractor" do
    patch :update, id: @contractor, contractor: { name: @contractor.name, note: @contractor.note, phone: @contractor.phone, type: @contractor.type }
    assert_redirected_to contractor_path(assigns(:contractor))
  end
