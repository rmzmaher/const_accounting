...
class PaysControllerTest < ActionController::TestCase
  ...
  test "should create pay" do
    assert_difference('Pay.count') do
      post :create, pay: { amount: @pay.amount, contractor_id: @pay.contractor_id, date: @pay.date, note: @pay.note }
    end
  ...
  test "should update pay" do
    patch :update, id: @pay, pay: { amount: @pay.amount, contractor_id: @pay.contractor_id, date: @pay.date, note: @pay.note }
    assert_redirected_to pay_path(assigns(:pay))
  end
