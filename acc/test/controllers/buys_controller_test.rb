...
class BuysControllerTest < ActionController::TestCase
  ...
  test "should create buy" do
    assert_difference('Buy.count') do
      post :create, buy: { date: @buy.date, good_id: @buy.good_id, note: @buy.note, paid: @buy.paid, price_per_unit: @buy.price_per_unit, quantity: @buy.quantity }
    end
  ...
  test "should update buy" do
    patch :update, id: @buy, buy: { date: @buy.date, good_id: @buy.good_id, note: @buy.note, paid: @buy.paid, price_per_unit: @buy.price_per_unit, quantity: @buy.quantity }
    assert_redirected_to buy_path(assigns(:buy))
  end
